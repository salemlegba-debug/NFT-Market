...
class SupabaseMarketStore:
    ...
    async def add_match(self, match: Any) -> None:
        payload = {
            ...
            "seller_listing_id": match.seller_listing.listing_id,
            "buyer_listing_id": match.buyer_listing.listing_id,
    ...
    async def get_active_matches(self, guild_id: int) -> List[Any]:
        ...
        # Récupère les matches non fermés
        ...
        for mr in match_records:
            # Récupère seller listing et buyer listing
            ...
            seller = Listing(
                ...
                amount=Decimal(str(sr["amount"])),
                details=sr["details"],
                mint_address=sr.get("mint_address"),
                active=sr["active"],
            ...
            buyer = Listing(
                ...
                kind=br["kind"],
                guild_id=br["guild_id"],
                user_id=br["user_id"],
                user_name=br["user_name"],
                collection=br["collection"],
                currency=br["currency"],
                amount=Decimal(str(br["amount"])),
                details=br["details"],
                mint_address=br.get("mint_address"),
                active=br["active"],
